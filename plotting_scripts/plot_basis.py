...
load_dir = 'basis_9/Integral/matrix_least_squares/2024-11-27_21-38-32/'
...
with torch.no_grad():
    ...
    # load models
    src_model.load_state_dict(torch.load(f"{load_dir}/src_model.pth", weights_only=True, map_location=device))
    tgt_model.load_state_dict(torch.load(f"{load_dir}/tgt_model.pth", weights_only=True, map_location=device))
